...
// ====================================================
// NAME:        IntersectionTwo2DSegs
// DESCRIPTION: Identify intersection between two 2D segments
// AUTHOR:      Tingchang YIN
// DATE:        07/05/2022
// ====================================================

__device__ __host__ bool cuDFNsys::IntersectionTwo2DSegs(float2 *Seg_1,
                                                         float2 *Seg_2,
                                                         float2 *intersection,
