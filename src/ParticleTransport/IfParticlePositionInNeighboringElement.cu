...
#include "ParticleTransport/IfParticlePositionInNeighboringElement.cuh"

// ====================================================
// NAME:        IfParticlePositionInNeighboringElement
// DESCRIPTION: If the particle is in a neighboring element
// AUTHOR:      Tingchang YIN
// DATE:        15/11/2022
// ====================================================
template <typename T>
__device__ __host__ bool cuDFNsys::IfParticlePositionInNeighboringElement(cuDFNsys::Vector2<T> Position_p,
                                                                          uint &EleID,
                                                                          ...
                                                                          T _TOL_p)
{
    ...
    return false;
}; // IfParticlePositionInNeighboringElement
