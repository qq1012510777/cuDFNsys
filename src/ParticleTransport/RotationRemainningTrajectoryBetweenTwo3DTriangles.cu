...
#include "ParticleTransport/RotationRemainningTrajectoryBetweenTwo3DTriangles.cuh"

// ====================================================
// NAME:        RotationRemainningTrajectoryBetweenTwo3DTriangles
// DESCRIPTION: rotate remanning trajectory between two adjacent elements
//              after the particle goes through a fracture trace
// AUTHOR:      Tingchang YIN
// DATE:        15/11/2022
// ====================================================
template <typename T>
__host__ __device__ cuDFNsys::Vector3<T> cuDFNsys::RotationRemainningTrajectoryBetweenTwo3DTriangles(const cuDFNsys::Vector3<T> preEle[3],
                                                                                                     const T &theta_angle)
{
    ...
    return new_Pnt;
}; // RotationRemainningTrajectoryBetweenTwo3DTriangles
template __host__ __device__ cuDFNsys::Vector3<double> cuDFNsys::RotationRemainningTrajectoryBetweenTwo3DTriangles<double>(const cuDFNsys::Vector3<double> preEle[3],
                                                                                                                           const double &theta_angle);
template __host__ __device__ cuDFNsys::Vector3<float> cuDFNsys::RotationRemainningTrajectoryBetweenTwo3DTriangles<float>(const cuDFNsys::Vector3<float> preEle[3],
