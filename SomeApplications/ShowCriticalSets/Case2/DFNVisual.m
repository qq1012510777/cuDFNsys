...
L = h5read([currentPath, '/DFNVisual.h5'], '/L_m');
DomainDimensionRatio = h5read([currentPath, '/DFNVisual.h5'], '/DomainDimensionRatio');
...
Frac_NUM_verts = h5read([currentPath, '/DFNVisual.h5'], '/Frac_NUM_verts');
verts = h5read([currentPath, '/DFNVisual.h5'], '/verts');
...
NumClusters = h5read([currentPath, '/DFNVisual.h5'], '/NumClusters');
ListClusters = {};
for i=1:NumClusters
	ListClusters{i, 1} = h5read([currentPath, '/DFNVisual.h5'], ['/Cluster_', num2str(i)]);
end
PercolationClusters = h5read([currentPath, '/DFNVisual.h5'], '/PercolationClusters');
...
figure(3);
Polar_Orientation = h5read([currentPath, '/DFNVisual.h5'], '/Polar_Orientation');
...
%% R = h5read([currentPath, '/DFNVisual.h5'], '/R');
%% figure(4);
%% nbins = 20;
