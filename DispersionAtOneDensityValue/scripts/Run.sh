...
FactorMeanTimeInGrid=25
MolecuDiffu=0
ControlPlaneSpacing=5000
# change above
MaxExeTimes=3000
SpecialChar="L50_II" # change this # change this  # change this # change this
###################################3
